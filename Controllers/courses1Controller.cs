...
namespace WebApplication88.Controllers
{
    public class courses1Controller : Controller
    {
        ...
        {
            var courses = db.courses.Include(c => c.dr);
        ...
        {
            ViewBag.courseid = new SelectList(db.drs, "drid", "drname");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "courseid,coursename")] course course)
        {
            ...
            ViewBag.courseid = new SelectList(db.drs, "drid", "drname", course.courseid);
            return View(course);
        }
